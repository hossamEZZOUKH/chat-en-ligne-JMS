...
public class LoginController implements Initializable {
    ...
    @FXML private ImageView asmaeview;
    @FXML private ImageView sanaeview;
    @FXML private ImageView ayaview;
    @FXML private ImageView leilaview;
    @FXML private ImageView jihadview;
                ...
                if (oldPicture != null) {
                    switch (oldPicture) {
                        case "Default":
                            ...
                            break;
                        case "sanae":
                            sanaeview.setVisible(false);
                            break;
                        case "asmae":
                            asmaeview.setVisible(false);
                            break;
                        case "aya":
                            ayaview.setVisible(false);
                            break;
                        case "leila":
                            leilaview.setVisible(false);
                            break;
                        case "jihad":
                            jihadview.setVisible(false);
                            break;
                    }
                }
                if (newPicture != null) {
                    switch (newPicture) {
                        case "Default":
                            ...
                            break;
                        case "sanae":
                            sanaeview.setVisible(true);
                            break;
                        case "asmae":
                            asmaeview.setVisible(true);
                            break;
                        case "aya":
                            ayaview.setVisible(true);
                            break;
                        case "leila":
                            leilaview.setVisible(true);
                            break;
                        case "jihad":
                            jihadview.setVisible(true);
                            break;
                    }
                }
            }
