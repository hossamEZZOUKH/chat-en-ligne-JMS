...
public class ChatController implements Initializable {
    ...
    public void sendButtonAction() throws IOException, JMSException, DuplicateUsernameException {
    ...
    public synchronized void addToChat(Message msg) {
        Task<HBox> othersMessages = new Task<HBox>() {
            ...
            public HBox call() throws Exception {
                ...
                bl6.setBackground(new Background(new BackgroundFill(Color.LIGHTCORAL,null, null)));
                HBox x = new HBox();
...
//                logger.debug("ONLINE USERS: " + Integer.toString(msg.getUserlist().size()));
    ...
    public void setImageLabel() throws IOException {
        this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/sanae.png").toString()));
    }
    ...
    public void setUserList(Message msg) {
        ...
        Platform.runLater(() -> {
        	// je pourrais utiliser Listener.getUsers();
            ObservableList<User> users = FXCollections.observableList(Listener.getUsers());
          //  ObservableList<User> users = FXCollections.observableList(msg.getUsers());
            userList.setItems(users);
            userList.setCellFactory(new CellRenderer());
            setOnlineLabel(String.valueOf(Listener.getUsers().size()));
//            setOnlineLabel(String.valueOf(msg.getUserlist().size()));
    ...
    public void sendMethod(KeyEvent event) throws IOException, JMSException, DuplicateUsernameException {
    ...
    public void setImageLabel(String selectedPicture) {
        ...
        case "sanae":
            ...
            break;
        case "asmae":
            this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/asmae.png").toString()));
            break;
        case "leila":
            this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/leila.png").toString()));
            break;
        case "aya":
            this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/aya.png").toString()));
            break;
        case "jihad":
            this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/jihad.png").toString()));
            break;
            case "Default":
